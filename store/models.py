...
class Post(models.Model):
    ...
    def __str__(self):
        return f"{self.title} Developer {self.developer}"
...
class Comment(models.Model):
    ...
    platinum_achieved = models.BooleanField(default=False, null=True, blank=True)
    platinum_stability = models.IntegerField(default=0, validators=[MinValueValidator(0), MaxValueValidator(10)], null=True, blank=True)
    glitched_trophies = models.BooleanField(default=False, null=True, blank=True)
    glitched_trophies_list = models.TextField(default='No Glitched Trophies Have Been Posted Here Yet..', null=True, blank=True)
    game_version = models.DecimalField(max_digits=6, decimal_places=2, default=0.00)
    playtime = models.IntegerField(default=0)
    PLATFORM_CHOICES = [
        ('PS4', 'PlayStation 4'),
